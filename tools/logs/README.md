...
- `extract_etggameplaydashboard_log.py`: extracts only `EtgGameplayDashboard`-owned lines
...
- `python .\tools\extract_etggameplaydashboard_log.py "C:\Game\steam\steamapps\common\Enter the Gungeon\BepInEx\LogOutput.log"`
