    ...
    internal static class Program
    {
        private static int Main()
        {
            KeyValuePair<string, Action>[] tests =
            {
                ...
                new KeyValuePair<string, Action>("LoadsJson5AliasesWithCommentsAndTrailingCommas", AliasRegistryTests.LoadsJson5AliasesWithCommentsAndTrailingCommas),
                ...
                new KeyValuePair<string, Action>("ParsesRuleFromPresetFileWithJson5Syntax", RuleFileProviderTests.ParsesRuleFromPresetFileWithJson5Syntax),
                ...
                new KeyValuePair<string, Action>("LoadsJson5RandomPoolState", RandomPoolSelectionStateProviderTests.LoadsJson5RandomPoolState),
                new KeyValuePair<string, Action>("SavesAndReloadsRandomPoolState", RandomPoolSelectionStateProviderTests.SavesAndReloadsRandomPoolState),
                new KeyValuePair<string, Action>("LoadsPresetDirectoryWhenAnchorFileIsMissing", RuleFileProviderTests.LoadsPresetDirectoryWhenAnchorFileIsMissing),
                new KeyValuePair<string, Action>("LoadsPresetDirectoryWhenAnchorFileIsInvalid", RuleFileProviderTests.LoadsPresetDirectoryWhenAnchorFileIsInvalid),
