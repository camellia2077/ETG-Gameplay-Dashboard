    ...
    internal sealed partial class InGameCommandController
    {
        ...
        private void Submit(PlayerController player, ManualLogSource logger)
        {
            ...
            if (!parseResult.Succeeded)
            {
                ...
                logger.LogWarning(EtgGameplayDashboardLog.Command(parseResult.ErrorMessage));
                return;
            }
        ...
        private void ExecuteToggleArmorNoConsume(PlayerController player, ManualLogSource logger)
        {
            if (_armorNoConsumeToggleService == null)
            {
                ...
                if (logger != null)
                {
                    logger.LogWarning(EtgGameplayDashboardLog.Command(GetLocalizedFallback(
                        "result.armor_no_consume.unavailable",
                        "Armor no-consume service is unavailable.",
                        "护甲不消耗服务当前不可用。")));
                }
        ...
        private void ExecuteToggleRapidFire(PlayerController player, ManualLogSource logger)
        {
            if (_rapidFireToggleService == null)
            {
                ...
                if (logger != null)
                {
                    logger.LogWarning(EtgGameplayDashboardLog.Command(GuiText.GetEnglish("result.rapid.unavailable")));
                }
        ...
        private void ExecuteToggleAutoReload(ManualLogSource logger)
        {
            ...
            if (_autoReloadToggleService == null)
            {
                ...
                if (logger != null)
                {
                    logger.LogWarning(EtgGameplayDashboardLog.Command(GuiText.GetEnglish("result.auto_reload.unavailable")));
                }
            ...
            if (_ammoModeToggleService != null && _ammoModeToggleService.Mode == AmmoMode.NoConsume)
            {
                ...
                if (logger != null)
                {
                    logger.LogWarning(EtgGameplayDashboardLog.Command("Auto Reload is disabled because ammo is not consumed, so reload will not trigger. To avoid unknown bugs, it stays disabled."));
                }
        ...
        private void ExecuteToggleInvincibility(PlayerController player, ManualLogSource logger)
        {
            if (_invincibilityToggleService == null)
            {
                ...
                if (logger != null)
                {
                    logger.LogWarning(EtgGameplayDashboardLog.Command(GuiText.GetEnglish("result.invincible.unavailable")));
                }
        ...
        private void ExecuteToggleEnemyHealthBars(PlayerController player, ManualLogSource logger)
        {
            if (_enemyHealthBarToggleService == null)
            {
                ...
                if (logger != null)
                {
                    logger.LogWarning(EtgGameplayDashboardLog.Command(GuiText.GetEnglish("result.enemy_health_bars.unavailable")));
                }
        ...
        private void ExecuteToggleKeyboardAimAssist(PlayerController player, ManualLogSource logger)
        {
            ...
            if (logger != null)
            {
                logger.LogInfo(EtgGameplayDashboardLog.Command(GuiText.GetEnglish(statusKey)));
            }
        }
        ...
        private void ExecuteCycleAmmoMode(ManualLogSource logger)
        {
            ...
            if (_ammoModeToggleService == null)
            {
                ...
                if (logger != null)
                {
                    logger.LogWarning(EtgGameplayDashboardLog.Command(GuiText.GetEnglish("result.no_ammo_consumption.unavailable")));
                }
        ...
        private void ExecuteToggleBossIntroSkip(ManualLogSource logger)
        {
            ...
            {
                logger.LogInfo(EtgGameplayDashboardLog.Command(GuiText.GetEnglish(key)));
            }
        }
