    ...
    internal sealed partial class InGameCommandController
    {
        private void OpenCharacterPage(ManualLogSource logger)
        {
            ...
            if (!string.Equals(_lastCharacterAvailabilityLog, _cachedCharacterAvailability, StringComparison.Ordinal))
            {
                ...
                logger.LogInfo(EtgGameplayDashboardLog.Command("Character page opened. " + _cachedCharacterAvailability));
            }
        }
        ...
        private void ToggleCharacterSwitchTarget(ManualLogSource logger)
        {
            ...
            if (logger != null)
            {
                logger.LogInfo(EtgGameplayDashboardLog.Command(GuiText.GetEnglish("result.characters.target_changed", englishTargetLabel)));
            }
        }
        ...
        private void ToggleCharacterActionMode(ManualLogSource logger)
        {
            ...
            if (logger != null)
            {
                logger.LogInfo(EtgGameplayDashboardLog.Command(logMessage));
            }
        }
