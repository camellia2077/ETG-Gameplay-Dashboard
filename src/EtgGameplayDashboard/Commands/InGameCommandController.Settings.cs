...
namespace EtgGameplayDashboard
{
    internal sealed partial class InGameCommandController
    {
        ...
        private void SetExperimentalModeEnabled(bool isEnabled, ManualLogSource logger)
        {
            ...
            if (logger != null)
            {
                logger.LogInfo(EtgGameplayDashboardLog.Command(GetEnglishExperimentalModeChangedMessage(isEnabled)));
            }
        }
        ...
        private void ExecuteCycleCommandPanelKey(ManualLogSource logger)
        {
            ...
            if (logger != null)
            {
                logger.LogInfo(EtgGameplayDashboardLog.Command(GuiText.GetEnglish("result.command_panel_key.changed", nextKeyName)));
            }
        }
        ...
        private void ExecuteCycleControllerShortcut(ManualLogSource logger)
        {
            ...
            if (logger != null) logger.LogInfo(EtgGameplayDashboardLog.Command(GuiText.GetEnglish("result.controller_shortcut.changed", displayName)));
        }
        ...
        private void ExecuteCycleUiScalePreset(ManualLogSource logger)
        {
            ...
            if (logger != null)
            {
                logger.LogInfo(EtgGameplayDashboardLog.Command(GetEnglishUiScaleChangedMessage(nextPreset)));
            }
        }
