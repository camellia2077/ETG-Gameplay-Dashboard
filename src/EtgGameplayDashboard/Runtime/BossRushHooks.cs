    ...
    internal static class BossRushHooks
    {
            ...
            ManualLogSource logger)
        {
            ...
            if (!string.IsNullOrEmpty(validationError))
            {
                ...
                if (logger != null)
                {
                    logger.LogWarning(EtgGameplayDashboardLog.Init("Boss Rush hook skipped: " + hookLabel + ". " + validationError));
                }
            ...
            try
            {
                ...
                if (logger != null)
                {
                    logger.LogInfo(EtgGameplayDashboardLog.Init("Boss Rush hook ready: " + hookLabel));
                }
            }
            catch (Exception ex)
            {
                ...
                if (logger != null)
                {
                    logger.LogWarning(EtgGameplayDashboardLog.Init("Boss Rush hook failed: " + hookLabel + ". " + ex.GetType().Name + ": " + ex.Message));
                }
            }
        }
