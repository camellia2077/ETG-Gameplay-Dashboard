    ...
    internal static class KeyboardAimAssistHooks
    {
        ...
        public static void Install(Harmony harmony, ManualLogSource logger)
        {
            ...
            if (target == null || postfix == null)
            {
                if (logger != null)
                {
                    logger.LogWarning(EtgGameplayDashboardLog.Init("Keyboard aim assist hook skipped: PlayerController.DetermineAimPointInWorld was not found."));
                }
            ...
            if (logger != null)
            {
                logger.LogInfo(EtgGameplayDashboardLog.Init("Keyboard aim assist hook ready: PlayerController.DetermineAimPointInWorld."));
            }
        }
