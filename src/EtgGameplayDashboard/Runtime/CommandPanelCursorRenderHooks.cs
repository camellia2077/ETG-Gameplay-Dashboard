...
namespace EtgGameplayDashboard
{
    internal static class CommandPanelCursorRenderHooks
    {
        ...
        private const string CursorOverrideKey = "EtgGameplayDashboard.CommandPanelCursorAbovePanel";
        ...
        public static void UpdateCursorOverride(bool panelVisible)
        {
            ...
            {
                s_logger.LogInfo(
                    EtgGameplayDashboardLog.CursorRender(
        ...
        public static void Install(Harmony harmony, ManualLogSource logger)
        {
            ...
            if (targetMethod == null || prefixMethod == null || postfixMethod == null)
            {
                if (logger != null)
                {
                    logger.LogWarning(EtgGameplayDashboardLog.Init("Cursor render diagnostics hook skipped: GameCursorController.OnGUI target or patch method was not found."));
                }
            ...
            try
            {
                ...
                if (logger != null)
                {
                    logger.LogInfo(EtgGameplayDashboardLog.Init("Cursor render diagnostics hook ready: GameCursorController.OnGUI prefix/postfix."));
                }
            }
            catch (Exception exception)
            {
                if (logger != null)
                {
                    logger.LogWarning(EtgGameplayDashboardLog.Init("Cursor render diagnostics hook failed: " + exception.GetType().Name + ": " + exception.Message));
                }
            }
        }
        ...
        private static void LogPanelCursorState(bool panelVisible, BraveInput cursorInput)
        {
            ...
            s_logger.LogInfo(EtgGameplayDashboardLog.CursorRender("Panel cursor state transition. " + state + "."));
        }
        ...
        private static bool EnsureCursorColorMaterial()
        {
            ...
            try
            {
                ...
                s_cursorColorMaterial.name = "EtgGameplayDashboard.CursorColorOverride";
        ...
        private static void LogCursorShaderFailure(string message)
        {
            if (s_logger != null)
            {
                s_logger.LogWarning(EtgGameplayDashboardLog.CursorRender("Cursor color shader unavailable: " + message));
            }
        }
