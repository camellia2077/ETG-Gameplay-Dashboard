...
namespace EtgGameplayDashboard
{
    internal static class GuiText
    {
        ...
        public static string GetCategoryLabel(EtgGameplayDashboard.Core.PickupCategory category)
        {
            return GetCategoryLabelInternal(category, false);
        }

        public static string GetEnglishCategoryLabel(EtgGameplayDashboard.Core.PickupCategory category)
        {
        ...
        private static string GetCategoryLabelInternal(EtgGameplayDashboard.Core.PickupCategory category, bool forceEnglish)
        {
            switch (category)
            {
                case EtgGameplayDashboard.Core.PickupCategory.Gun:
                    return ResolveWithFallback("label.category.gun", "Gun", forceEnglish);
                case EtgGameplayDashboard.Core.PickupCategory.Passive:
                    return ResolveWithFallback("label.category.passive", "Passive", forceEnglish);
                case EtgGameplayDashboard.Core.PickupCategory.Active:
