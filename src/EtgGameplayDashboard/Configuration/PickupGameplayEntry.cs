...
namespace EtgGameplayDashboard
{
    ...
    {
        public PickupGameplayStatEntry(string key, PickupGameplayStatPart[] parts)
        {
            Key = key ?? string.Empty;
            Parts = parts ?? new PickupGameplayStatPart[0];
        }

        public string Key { get; private set; }

        public PickupGameplayStatPart[] Parts { get; private set; }
    }

    internal sealed class PickupGameplayStatPart
    {
        public PickupGameplayStatPart(string value, string label)
        {
